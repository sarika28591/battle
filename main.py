...
while running:
    ...
    print("Your HP" , bcolors.OKGREEN + str(enemy.get_hp()) + "/" + str(enemy.get_max_hp()) + bcolors.ENDC)
    print("Your HP", bcolors.OKBLUE + str(enemy.get_mp()) + "/" + str(enemy.get_max_mp()) + bcolors.ENDC + "\n")
